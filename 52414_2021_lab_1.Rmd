...
data=full_join(data,joindata,by = "location")
data=na.omit(data)
...
```{r}
ggplot(sub_data,aes_string(y='two_dose_fraction',col="location"))+ geom_line(aes(x=as.Date(date)), size=1)+ylab('two dose fraction')+xlab("months")+theme_bw()
```
